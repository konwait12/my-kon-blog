...
![image-20250805101551085](正向代理、反向代理、正向 Shell 和反弹 Shell.assets/image-20250805101551085.png)
...
- **访问记录**：回溯访问日志，如企业中某些敏感资源需要通过代理服务器（跳板机）进行访问。企业可以通过查看代理服务器的访问日志，了解员工对敏感资源的访问情况，进行审计和安全管控。
  ...
  ![image-20250805101621968](正向代理、反向代理、正向 Shell 和反弹 Shell.assets/image-20250805101621968.png)
...
- **路由功能**：代理服务器针对不同的查询内容，将请求路由到不同的服务器。比如，在一个同时提供 Web 服务和 API 服务的系统中，反向代理可以根据请求的 URL 路径，将对/web/开头路径的请求路由到 Web 服务器，将对/api/开头路径的请求路由到 API 服务器。
  ...
  ![image-20250805101640461](正向代理、反向代理、正向 Shell 和反弹 Shell.assets/image-20250805101640461.png)
